javascript:(function(){
  const p = new Game.Upgrade('YouTube Player', 'Click to open', 0, [0, 0, 'https://raw.githubusercontent.com/DeanHawley/Random-Stuff/main/7559929_youtube_video_pixel_logo_site_icon.png']);
  p.pool = 'toggle';
  p.order = 1e6;
  p.unlock();
